...
export default function Home() {
    ...
    return (
        <Flex flexFlow="column wrap" alignItems="center" text-align="center" bg="brand.800" h="100vh">
                <Heading textAlign="center" as="h4" color="brand.600" fontSize="26px" fontWeight="300" mb="6" lineHeight="1.5" flexShrink="0">
                    Create your own flashcard deck and save sticky notes on...
                </Heading>
            <Box alignSelf="center" flexShrink="2" w="500px" maxW="80%">
